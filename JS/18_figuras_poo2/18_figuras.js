...
calcularAreaCilindro = function() {
        this.resultado.value = (2 * Math.PI * Math.pow(parseInt(this.ancho.value), 2)) + 2 * Math.PI * parseInt(this.ancho.value) * parseInt(this.alto.value);
    }
    // Rectangulo
...
var Cilindro = HeredarFigurar(calcularAreaCilindro, "Cilindro");