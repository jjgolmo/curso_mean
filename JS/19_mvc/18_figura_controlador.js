...
FiguraControlador.prototype.calculaDoblePerimetro = function(ancho, alto) {
    var doblePerimetroCalculado = this.modelo.calculardobleperimetro(ancho, alto);
    this.vista.mostrarDoblePerimetro(doblePerimetroCalculado);
}