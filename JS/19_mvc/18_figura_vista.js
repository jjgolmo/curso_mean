var FiguraVista = function(padreDom, nombre) {
    if (padreDom) {
        ...
        this.dobleperimetro = CreadorDOM.addInput(this.formCalc, "Doble Perimetro", "dobleperimetro");
        ...
        CreadorDOM.addButton(this, " Doble Perímetro " + nombre, this.pulsarCalcularDoblePerimetro);
    }
}
...
FiguraVista.prototype.pulsarCalcularDoblePerimetro = function() {
    this.controlador.calculaDoblePerimetro(parseInt(this.alto.value), parseInt(this.ancho.value));
}
...
FiguraVista.prototype.mostrarDoblePerimetro = function(dobleperimetro) {
    this.dobleperimetro.value = dobleperimetro;
}