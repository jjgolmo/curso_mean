var FiguraVistaV2 = function(padreDom, nombre) {
    if (padreDom) {
        ...
        //botón doble perimetro
        CreadorDOM.addButton(this, " DOBLE PERIMETRO " + nombre, this.pulsarCalcularDoblePerimetro);
        this.dobleperimetro = document.createElement("span");
        this.dobleperimetro.innerHTML = " Resultado Doble perimetro";
        this.formCalc.appendChild(this.dobleperimetro);
        this.formCalc.appendChild(document.createElement("BR"));
        this.formCalc.appendChild(document.createElement("BR"));
    }
}
...
FiguraVistaV2.prototype.pulsarCalcularDoblePerimetro = FiguraVista.prototype.pulsarCalcularDoblePerimetro;
...
FiguraVistaV2.prototype.mostrarDoblePerimetro = function(dobleperimetro) {
    this.perimetro.innerHTML = "El perimetro es " + dobleperimetro;
}